...
17. МАГМА (ГОСТ Р 34.12-2015)  (ЛАБКРИПТ_2022)

Блочный шифр на основе сети Фейстеля. Блок 64 бита делится на половины
a1 ≙ L и a0 ≙ R. Функция f (здесь _g): сложение с подключом по модулю 2^32,
замена по S-блокам (узел замены), циклический сдвиг на 11 бит влево.
256-битный ключ даёт восемь подключей K_1…K_8 (порядок 32 раундов:
K1..K8, K1..K8, K1..K8, K8..K1). 31 раунд с перестановкой половин, 32-й — без.
"""
