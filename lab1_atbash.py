...
1. Шифр простой замены АТБАШ  (ЛАБКРИПТ_2022)

Формула:  Y_i = X_(n - i + 1)
    X — исходный (открытый) текст,
    Y — зашифрованный текст,
    i — порядковый номер буквы в открытом алфавите (i = 1…n),
    n — количество букв в алфавите (n = 32).
Зеркальная замена: А↔Я, Б↔Ю, …, Я↔А (ключ не требуется).
"""
