...
21. RSA  (ЛАБКРИПТ_2022)

P, Q — большие простые числа,  N = P·Q,  φ(N) = (P-1)·(Q-1).
Открытый ключ (E, N): E взаимно просто с φ(N), 1 < E < φ(N).
Секретный ключ D = E^(-1) mod φ(N).
Шифрование:    C_i = M_i^E mod N.
Расшифрование: M_i = C_i^D mod N.
"""
